    ...
    <>
      <div className='rounded-xl p-3  md:p-5 md:px-0 border-dashed border-[#171717] border-2 my-5 md:my-16'>
        ...
        <p className='px-5 py-3 md:py-1 flex text-xs text-[#676665] '>
          ...
          <span className='flex py-0.5 items-center ml-2 px-2 text-xs rounded-2xl bg-[#8bf2651e] text-[#8AF265]'>In stock</span>
        </p>
        <div className='border-t-2 border-dashed mt-10 p-2 md:p-5 border-[#171717] flex flex-col lg:flex-row justify-center md:gap-10 lg:gap-14 xl:gap-40 items-center'>
          ...
          <div className='flex justify-center  lg:flex-col gap-5 md:gap-8'>
              <Image src='/person-left.svg'
               className='w-2/5 md:w-[200px]' width={200} height={200} alt='Human picture'/>
              <Image src='/person-right.svg' className='w-2/5 md:w-[200px]'  width={200} height={200} alt='Human picture'/>
          </div>
          <div className='flex justify-between mt-5 md:mt-0 md:gap-10 items-center '>
              <ChevronLeft className='text-white cursor-pointer' size={32} strokeWidth={2}/>
              <Image src='/person.svg' width={500} height={500} 
              className='w-4/5 md:w-[500px] md:h-[500px]'
              alt='Product Image'/>
              <ChevronRight className='text-white cursor-pointer' size={32} strokeWidth={2}/>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col md:flex-row pt-5 md:pt-10'>
        ...
        <div className='w-full md:w-3/4'>
          ...
          <p className='text-[#81807E] border-b-2 border-dashed border-[#171717] px-8 py-5 text-xs'>
            Tracing its roots back to ancient Greek draped garments, has evolved through centuries, often crafted from luxurious fabrics like silks, satins, and velvets.Flowing from Grecian folds to glittering silks, the evening gown has graced centuries in luxury.
          </p>
          
          <div className='px-8 py-5 border-b-2 border-dashed border-[#171717]'>
            <span className='text-white inline-block mb-3 text-sm'>Materials</span>
          ...
          <div className='px-8 py-5 mb-5 border-b-2 border-dashed border-[#171717]'>
            <span className='text-white mb-5 inline-block text-sm'>Color Options</span>
          ...
          <div className='border-b-2 border-dashed border-[#171717] pb-8'>
            <span className='text-white px-5 inline-block mb-3 text-sm'>
              ...
              <div className='flex gap-3  px-5 mt-3'>
                ...
                <span className='bg-[#1A1A1A] text-white p-2 text-xs rounded-2xl flex items-center justify-center px-6'>S</span>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 sm:my-20 lg:my-30'>
        {ReviewsData.map((review, index) => (
          <Reviews key={index} reiewsObject={{
            name: review.name,
